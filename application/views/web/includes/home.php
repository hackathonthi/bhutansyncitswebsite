<section id="home" class="p-0">
  <div id="main-slide" class="cd-hero">
    <ul class="cd-hero-slider">
      ...
      <li>
        <div class="overlay2">
          <img class="" src="<?php echo base_url();?>assest/images/slider/bg2.jpg" alt="slider">
        </div>
        ...
        <div class="cd-half-width cd-img-container">
          <img src="<?php echo base_url();?>assest/images/slider/bg-thumb1.png" alt="">
        </div> <!-- .cd-half-width.cd-img-container -->
      </li>
      <li>
        <div class="overlay2">
          <img class="" src="<?php echo base_url();?>assest/images/slider/bg3.jpg" alt="slider">
        </div>
        <div class="cd-half-width cd-img-container img-right">
          <img src="<?php echo base_url();?>assest/images/slider/bg-thumb2.png" alt="">
        </div> <!-- .cd-half-width.cd-img-container -->
        <div class="cd-half-width">
  ...
  <div class="container-fluid">
    <div class="row isotope" id="isotope">
        ...
        <div class="grid">
          <figure class="m-0 effect-oscar">
            ...
            <figcaption>
              ...
              <a class="view icon-pentagon" data-rel="prettyPhoto" href="<?php echo base_url();?>assest/images/portfolio/portfolio-bg1.jpg"><i
        ...
        <div class="grid">
          <figure class="m-0 effect-oscar">
            ...
            <figcaption>
              ...
              <a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
              <a class="view icon-pentagon" data-rel="prettyPhoto" href="<?php echo base_url();?>assest/images/portfolio/portfolio-bg2.jpg"><i
                  class="fa fa-search"></i></a>
            </figcaption>
          </figure>
        </div>
      ...
      <div class="col-sm-3 joomla isotope-item">
        <div class="grid">
          <figure class="m-0 effect-oscar">
            <img src="<?php echo base_url();?>assest/images/portfolio/portfolio3.jpg" alt="">
            <figcaption>
              <h3>Your Business</h3>
              <a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
              <a class="view icon-pentagon" data-rel="prettyPhoto" href="<?php echo base_url();?>assest/images/portfolio/portfolio-bg3.jpg"><i
                  class="fa fa-search"></i></a>
            </figcaption>
          </figure>
        </div>
      ...
      <div class="col-sm-3 wordpress isotope-item">
        <div class="grid">
          <figure class="m-0 effect-oscar">
            <img src="<?php echo base_url();?>assest/images/portfolio/portfolio4.jpg" alt="">
            <figcaption>
              <h3>Prego Match</h3>
              <a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
              <a class="view icon-pentagon" data-rel="prettyPhoto" href="<?php echo base_url();?>assest/images/portfolio/portfolio-bg4.jpg"><i
                  class="fa fa-search"></i></a>
            </figcaption>
          </figure>
        </div>
      ...
      <div class="col-sm-3 joomla isotope-item">
        <div class="grid">
          <figure class="m-0 effect-oscar">
            <img src="<?php echo base_url();?>assest/images/portfolio/portfolio5.jpg" alt="">
            <figcaption>
              <h3>Fashion Brand</h3>
              <a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
              <a class="view icon-pentagon" data-rel="prettyPhoto" href="<?php echo base_url();?>assest/images/portfolio/portfolio-bg5.jpg"><i
                  class="fa fa-search"></i></a>
            </figcaption>
          </figure>
        </div>
      ...
      <div class="col-sm-3 development isotope-item">
        <div class="grid">
          <figure class="m-0 effect-oscar">
            <img src="<?php echo base_url();?>assest/images/portfolio/portfolio6.jpg" alt="">
            <figcaption>
              <h3>The Insidage</h3>
              <a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
              <a class="view icon-pentagon" data-rel="prettyPhoto" href="<?php echo base_url();?>assest/images/portfolio/portfolio-bg1.jpg"><i
      ...
      <div class="col-sm-3 development isotope-item">
        <div class="grid">
          <figure class="m-0 effect-oscar">
            <img src="<?php echo base_url();?>assest/images/portfolio/portfolio7.jpg" alt="">
            <figcaption>
              <h3>Light Carpet</h3>
              <a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
              <a class="view icon-pentagon" data-rel="prettyPhoto" href="<?php echo base_url();?>assest/images/portfolio/portfolio-bg2.jpg"><i
      ...
      <div class="col-sm-3 development isotope-item">
        <div class="grid">
          <figure class="m-0 effect-oscar">
            <img src="<?php echo base_url();?>assest/images/portfolio/portfolio8.jpg" alt="">
            <figcaption>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-6 ts-padding"
        style="height:650px;background:url(<?php echo base_url();?>assest/images/image-block-bg.jpg) 50% 50% / cover no-repeat;">
      </div>
      ...
      <div id="testimonial-carousel" class="owl-carousel owl-theme text-center testimonial-slide">
        <div class="item">
          <div class="testimonial-thumb">
            <img src="<?php echo base_url();?>assest/images/team/testimonial1.jpg" alt="testimonial">
          </div>
        ...
        <div class="item">
          <div class="testimonial-thumb">
            <img src="<?php echo base_url();?>assest/images/team/testimonial2.jpg" alt="testimonial">
          </div>
          <div class="testimonial-content">
            <p class="testimonial-text">
              Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover many web sites still
        ...
        <div class="item">
          <div class="testimonial-thumb">
            <img src="<?php echo base_url();?>assest/images/team/testimonial3.jpg" alt="testimonial">
          </div>
          <div class="testimonial-content">
            <p class="testimonial-text">
              Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover many web sites still
    ...
    <div class="row wow fadeInLeft">
      <div id="client-carousel" class="col-sm-12 owl-carousel owl-theme text-center client-carousel">
        <figure class="m-0 item client_logo">
          <a href="#">
            <img src="<?php echo base_url();?>assest/images/clients/client1.png" alt="client">
          </a>
        </figure>
        <figure class="m-0 item client_logo">
          <a href="#">
            <img src="<?php echo base_url();?>assest/images/clients/client2.png" alt="client">
          </a>
        </figure>
        <figure class="m-0 item client_logo">
          <a href="#">
            <img src="<?php echo base_url();?>assest/images/clients/client3.png" alt="client">
          </a>
        </figure>
        <figure class="m-0 item client_logo">
          <a href="#">
            <img src="<?php echo base_url();?>assest/images/clients/client4.png" alt="client">
          </a>
        </figure>
        <figure class="m-0 item client_logo">
          <a href="#">
            <img src="<?php echo base_url();?>assest/images/clients/client5.png" alt="client">
          </a>
        </figure>
        <figure class="m-0 item client_logo">
          <a href="#">
            <img src="<?php echo base_url();?>assest/images/clients/client6.png" alt="client">
          </a>
        </figure>
        <figure class="m-0 item client_logo">
          <a href="#">
            <img src="<?php echo base_url();?>assest/images/clients/client7.png" alt="client">
          </a>
        </figure>
        <figure class="m-0 item client_logo">
          <a href="#">
