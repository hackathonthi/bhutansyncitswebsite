  ...
  <div id="main-slide" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="img-fluid" src="<?php echo base_url();?>assest/images/slider2/bg1.jpg" alt="slider">
        <div class="slider-content">
          <div class="col-md-12 text-center">
            ...
            <p class="animated4"><a href="#" class="slider btn btn-primary white">Check For More Details</a></p>
          </div>
        </div>
      </div>
    </div>
