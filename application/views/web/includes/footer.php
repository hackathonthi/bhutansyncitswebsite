...
<script type="text/javascript">
	function loadpage(type){
        ...
        var url='<?php echo base_url();?>index.php?baseController/loadpage/'+type;
      	$("#mainpublicContent").load(url);
      	setTimeout($.unblockUI, 1000); 
    }
</script>

<script src="<?php echo base_url();?>assest/website/plugins/jQuery/jquery.min.js"></script>
<!-- Bootstrap JS -->
<script src="<?php echo base_url();?>assest/website/plugins/bootstrap/bootstrap.min.js"></script>
<!-- Style Switcher -->
<script type="text/javascript" src="<?php echo base_url();?>assest/website/plugins/style-switcher.js"></script>
<!-- Owl Carousel -->
<script type="text/javascript" src="<?php echo base_url();?>assest/website/plugins/owl/owl.carousel.js"></script>
<!-- PrettyPhoto -->
<script type="text/javascript" src="<?php echo base_url();?>assest/website/plugins/jquery.prettyPhoto.js"></script>
<!-- Bxslider -->
<script type="text/javascript" src="<?php echo base_url();?>assest/website/plugins/flex-slider/jquery.flexslider.js"></script>
<!-- CD Hero slider -->
...
<!-- Eeasing -->
<script type="text/javascript" src="<?php echo base_url();?>assest/website/plugins/jquery.easing.1.3.js"></script>
<!-- Counter -->
<script type="text/javascript" src="<?php echo base_url();?>assest/website/plugins/jquery.counterup.min.js"></script>
<!-- Waypoints -->
<script type="text/javascript" src="<?php echo base_url();?>assest/website/plugins/waypoints.min.js"></script>
<!-- google map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcABaamniA6OL5YvYSpB3pFMNrXwXnLwU&libraries=places"></script>
<script src="<?php echo base_url();?>assest/website/plugins/google-map/gmap.js"></script>
