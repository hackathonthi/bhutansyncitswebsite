			...
			<div class="col-md-6 col-sm-6">
				<div class="team team-list wow slideInLeft">
					...
					<div class="team-content">
						<h3>Vosgi Varduhi</h3>
						<p>Web Designer</p>
						<p class="desc">Eradicate invest honesty human rights accessibility theory of social change. Diversity
			...
			<div class="col-md-6 col-sm-6">
				<div class="team team-list wow slideInRight">
					...
					<div class="team-content">
						<h3>Robert Aleska</h3>
						<p>Web Designer</p>
						<p class="desc">Carbon emissions reductions giving, legitimize amplify non-partisan Aga Khan. Policy
							dialogue assessment expert free-speech cornerstone disruptor freedom. Cesar Chavez empower.</p>
						<div class="team-social">
							<a class="fb" href="#"><i class="fa fa-facebook"></i></a>
							<a class="twt" href="#"><i class="fa fa-twitter"></i></a>
							<a class="gplus" href="#"><i class="fa fa-google-plus"></i></a>
