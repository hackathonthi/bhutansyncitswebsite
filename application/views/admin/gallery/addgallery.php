    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h4 class="alert alert-info">Add Images & Banners</h4>
        </div>
        <div class="box-body">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  <div class="form-group row">
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                          ...
                          <input type="text" name="gallery" id="gallery" class="form-control" placeholder="Gallery Title" onclick="removeer('title_err')">
                          <span id="title_err"  class="text-danger"></span>
                      </div>
                  </div>
                  <div class="form-group row">
                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          <label>Show the text on slider?</label>
                          <select name="status_text" class="form-control">
                          <option value="Yes">Yes, Show</option>
                          <option value="No">No, Don't Show Text</option>
                        </select>
                      </div>
                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <label>Gallery Type:</label>
                        <select name="jenis_galeri" class="form-control">
                        <option value="Galeri">Ordinary Gallery</option>
                        <option value="Homepage">Homepage - Picture Slider</option>
