      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span>Gallary & Banner</span>
            <span class="pull-right-container">
              <span class="label label-primary pull-right">3</span>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="#" class="nav-link" onclick="loadpage('<?php echo base_url();?>index.php?adminController/loadgallery/listgallary/')"><i class="fa fa-circle-o"></i> View Gallery Date</a></li>
            <li><a href="#" class="nav-link" onclick="loadpage('<?php echo base_url();?>index.php?adminController/loadgallery/addgallery/')"><i class="fa fa-circle-o"></i> Add Gallery</a></li>
            <li><a href="#" class="nav-link" onclick="loadpage('<?php echo base_url();?>index.php?adminController/loadgallery/gallerycategory/')"><i class="fa fa-circle-o"></i> Gallery Category</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
