      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php foreach($Category as $i=> $event): ?>
            <tr>
              <td><?=$i+1?></td>
              <td><?php echo $event['category_name'];?></td>
              <td><?php echo $event['slug'];?></td>
              <td>
                <button type="button" class="btn btn-info btn-block" onclick="editservicecategory('<?php echo $event['category_id']?>','<?php echo $event['category_name']?>','<?php echo $event['slug']?>')"><i class="fa fa-edit"></i>Update</button>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
          ...
          <div class="modal-body">
            <?php echo form_open('#' , array('class' => 'form-horizontal validatable','id'=>'updateservicecategory', 'enctype' => 'multipart/form-data'));?>
            <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                          ...
                          <button class="btn btn-success" type="button" onclick="updateservicecategorydetails()"> <i class="fa fa-check"></i>Update</button>
                        </div>
                    </div>
                  </div>
              </div>
  ...
  function showrole(id,name,shortcode){
    ...
    function deleteservicecategory(id){
      $.blockUI
        ...
        var url='<?php echo base_url();?>index.php?adminController/Deleteservicecategory/'+id+'/admin/service/servicecategory';
    ...
    function editservicecategory(){
      ...
      var options = {target: '#mainContentdiv',url:url,type:'POST',data: $("#updateservicecategory").serialize()}; 
      $("#updateservicecategory").ajaxSubmit(options);
